...
from torch.nn import Flatten, Linear, Conv2d, MaxPool2d, Dropout, Sequential, ReLU, BatchNorm2d
...
def create_compile_model(channel=3, info=False):
    ...
    optimizer = optim.Adam(model.parameters(), lr=0.0004, weight_decay=0.00002)
    model.optimizer = optimizer
    model.loss_func = nn.CrossEntropyLoss()

    return model

def train_model(device, train_loader, val_loader, max_epochs, patience=3):
